...
/// <summary>
/// Class <c>SeedDataOnDemand</c> static class for bootstraping the required data 
/// during the startup
/// </summary>
public static class SeedDataOnDemand
{
    /// <summary>
    ...
    public static void Initialize(IServiceProvider serviceProvider)
    {
        ...
        try
        {
            ...
            // Adding User
            string resourceName = "Entities.Migrations.UserTest.csv";
            ...
            // Adding UserSecret
            resourceName = "Entities.Migrations.UserSecretTest.csv";
    ...
    public static void PopulateTestData(IServiceProvider serviceProvider)
    {
